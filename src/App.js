    ...
    return (
      <div className="App">
        ...
        <ul>
          ...
          <li>Tapones promediados: {this.state.playerStats["blk"]}</li>
          <br />

          <li> Robos promediados: {this.state.playerStats["stl"]}</li>
          <br />

          <li>Pérdidas promediadas: {this.state.playerStats["turnover"]}</li>
